	...
	function weblizar_default_settings()
{
	...
	{	
         ...
         *         'secondary' => __( 'Second Menu', 'enigma' )
         *         ));
         */
...
/**
 * function register_my_newmenu() {
 * 	register_nav_menu('secondary',__( 'Second Menu' ));
 * 	}	
 * 	add_action( 'init', 'register_my_newmenu' );
 * 	
...
function print_menu_shortcode() {?>
    	<div class="navigation_menu " data-spy="affix" id="enigma_nav_top">
