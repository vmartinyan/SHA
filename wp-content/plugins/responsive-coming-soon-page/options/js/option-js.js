/*Admin options pannal data value*/
	function weblizar_rcsm_option_data_save(name) 
	{ 	//tinyMCE.triggerSave();
...
/*Admin options value reset */
	function weblizar_rcsm_option_data_reset(name) 
	{  
...
jQuery(document).ready(function(){	
	...
	jQuery('#weblizar_home_layout_save_pagelayoutmanger').click(function(){ 
		...
		var dataStringfirst = 'rcsm_layout_data='+ data;				
	...
	var r=confirm("Do you want reset all plugin settings as default!")
		if (r==true)
		{
			var weblizar_settings_save_success = ".success-msg";		
			var weblizar_loding = ".msg-overlay";				
			var rcsm_hidden_box_id= "#weblizar_rcsm_settings_all_restored_settings_option";		
...
/*Download Subscribed User list from subscribe data table */
	jQuery('#weblizar_rcsm_subscriber_users_subscribed_download').click(function(){
		var rcsm_hidden_box_id= "#weblizar_rcsm_subscriber_users_action";
		var layout_form_id = "#weblizar_rcsm_subscribe_form";				
		var weblizar_settings_download_success = ".download-msg";
		var weblizar_loding = ".msg-overlay";	
...
{	
  ...
  slider_imgs++;
  jQuery('#rcsm_slider_fields').append('<div class="col-md-12 form-group" id="rcsm_slider-'+slider_imgs+'"><label>Slider Image '+slider_imgs+'</label><br/><div class="col-md-6"><input class="form-control" type="text" value="http://localhost/coming_soon/wp-content/plugins/Coming-soon-and-maintenace-mode/options/themes/comming-soon/images/1.jpg" id="slide_img'+slider_imgs+'" name="slide_img'+slider_imgs+'" size="36" class="upload has-file"/><button type="button" class="btn upload_image_button">Upload Image</button></div><div class="col-md-6"><label><a href="#" data-toggle="tooltip" data-placement="right" title="Add Bakcground Image Here"><i class="fa fa-info-circle tt-icon"></i></a></label></div></div>');
...
{	
  ...
  services_data++;
jQuery('#rcsm_services_fields').append('<div class="col-md-12 form-group" id="rcsm_services-'+services_data+'"><div class="col-md-6"><label>Service Title '+services_data+'</label><label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="Enter services title Here"><i class="fa fa-info-circle tt-icon"></i></a></label><br/><div class="col-md-12"><input  class="form-control" type="text" name="services_title'+services_data+'" id="services_title'+services_data+'"  value="" ></div></div><div class="col-md-6"><label>Service Icon '+services_data+'</label><label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="Enter services icon Here"><i class="fa fa-info-circle tt-icon"></i></a></label><br/><div class="col-md-12"><input  class="form-control" type="text" name="services_icon'+services_data+'" id="services_icon'+services_data+'"  value="" ></div></div><div class="col-md-6"><label>Link '+services_data+'</label><label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="Enter Link Url Here"><i class="fa fa-info-circle tt-icon"></i></a></label><br/><div class="col-md-12"><input  class="form-control" type="text" name="services_link'+services_data+'" id="services_link'+services_data+'"  value="#" ></div></div><div class="col-md-6"><label>Service Discription '+services_data+'</label><label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="Enter service discription Here"><i class="fa fa-info-circle tt-icon"></i></a></label><br/><div class="col-md-12"><textarea class="form-control" rows="4" id="services_dis'+services_data+'" name="services_dis'+services_data+'"></textarea></div></div></div>'); 
...
{	
  ...
  testimonials_data++;
jQuery('#rcsm_testimonial_fields').append('<div class="col-md-12 form-group" id="rcsm_testimonial-'+testimonials_data+'"><div class="col-md-6"><label>Testimonial Title '+testimonials_data+'</label><label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="Enter Testimonials Title Here"><i class="fa fa-info-circle tt-icon"></i></a></label><br/><div class="col-md-12"><input class="form-control" type="text" name="testimonials_title'+testimonials_data+'" id="testimonials_title'+testimonials_data+'"  value="" ></div></div><div class="col-md-6"><label>Testimonial Sub Title '+testimonials_data+'</label><label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="Enter Testimonials Sub Title Here"><i class="fa fa-info-circle tt-icon"></i></a></label><br/><div class="col-md-12"><input class="form-control" type="text" name="testimonials_sub_title'+testimonials_data+'" id="testimonials_sub_title'+testimonials_data+'"  value="" ></div></div><div class="col-md-6"><label>Testimonial Image '+testimonials_data+'</label><label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="Enter Testimonials Image Here"><i class="fa fa-info-circle tt-icon"></i></a></label><br/><div class="col-md-12"><input class="form-control" type="text" value="" id="testimonials_img'+testimonials_data+'" name="testimonials_img'+testimonials_data+'" size="36" class="upload has-file"/><button type="button" class="btn upload_image_button">Upload Image</button></div></div><div class="col-md-6"><label>Link '+testimonials_data+'</label><label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="Enter Link Url Here"><i class="fa fa-info-circle tt-icon"></i></a></label><br/><div class="col-md-12"><input  class="form-control" type="text" name="testimonials_link'+testimonials_data+'" id="testimonials_link'+testimonials_data+'"  value="#" ></div></div><div class="col-md-6"><label>Testimonial Discription '+testimonials_data+'</label><label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="Enter Testimonial discription Here"><i class="fa fa-info-circle tt-icon"></i></a></label><br/><div class="col-md-12"><textarea class="form-control" rows="4" id="testimonials_dis'+testimonials_data+'" name="testimonials_dis'+testimonials_data+'"></textarea></div></div></div>'); 
...
{	
  ...
  team_data++;
jQuery('#rcsm_team_fields').append('<div class="col-md-12 form-group" id="rcsm_team-'+team_data+'"><div class="col-md-6"><label>Team Member Title '+team_data+'</label><label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="Enter Team Member title Here"><i class="fa fa-info-circle tt-icon"></i></a></label><br/><div class="col-md-12"><input class="form-control" type="text" name="team_mem_title'+team_data+'" id="team_mem_title'+team_data+'"  value="" ></div></div><div class="col-md-6"><label>Team Member Image '+team_data+'</label><label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="Enter Team Member Image Here"><i class="fa fa-info-circle tt-icon"></i></a></label><br/><div class="col-md-12"><input class="form-control" type="text" value="" id="team_icon'+team_data+'" name="team_icon'+team_data+'" size="36" class="upload has-file"/><button type="button" class="btn upload_image_button">Upload Image</button></div></div><div class="col-md-6"><label>Link '+team_data+'</label><label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="Enter Link Url Here"><i class="fa fa-info-circle tt-icon"></i></a></label><br/><div class="col-md-12"><input class="form-control" type="text" name="team_mem_link'+team_data+'" id="team_mem_link'+team_data+'"  value="#" ></div></div><div class="col-md-6"><label>Team Member Discription '+team_data+'</label><label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="Enter Team discription Here"><i class="fa fa-info-circle tt-icon"></i></a></label><br/><div class="col-md-12"><textarea class="form-control" rows="4" id="team_mem_dis'+team_data+'" name="team_mem_dis'+team_data+'"></textarea></div></div></div>'); 
