 ...
 */
if(isset($_POST['weblizar_rcsm_settings_save_skin-layout_option'])) {	
	if($_POST['weblizar_rcsm_settings_save_skin-layout_option'] == 1) {	
		foreach($_POST as  $key => $value) {
			$wl_rcsm_options[$key]=sanitize_text_field($_POST[$key]);	
		}
		update_option('weblizar_rcsm_options', stripslashes_deep($wl_rcsm_options));
	}	
	if($_POST['weblizar_rcsm_settings_save_skin-layout_option'] == 2) {
