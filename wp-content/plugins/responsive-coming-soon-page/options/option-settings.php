...
<div class="col-xs-10 tab-content" id="spa_general"> <!-- plugin dashboard Main class div setting -->
	...
	<div class="tab-pane col-md-12 active" id="general-settings"><!-- plugin General selection setting -->
	...
	<div class="tab-pane col-md-12" id="skin-layout-settings">
		<div class="col-md-12 option">
			<h1><?php _e('Skin Color Settings','RCSM_TEXT_DOMAIN'); ?></h1>
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#skin-layout"><?php _e('Skin Color Selection Settings','RCSM_TEXT_DOMAIN'); ?></a></li>
			</ul>			
			<div class="tab-content">
				<div id="skin-layout" class="tab-pane fade in active"> <!-- Layout selection setting -->
					<form method="post" id="weblizar_rcsm_skin-layout_option">
						<h1> <?php _e('Skin Color Selection Settings','RCSM_TEXT_DOMAIN'); ?></h1>
						<div class="col-md-12 form-group">
						...
						<div class="restore">
							<input type="hidden" value="1" id="weblizar_rcsm_settings_save_skin-layout_option" name="weblizar_rcsm_settings_save_skin-layout_option" />
							<input class="button left" type="button" name="reset" value="<?php _e('Restore Defaults','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_reset('skin-layout_option');">
							<input class="button button-primary left" type="button" value="<?php _e('Save Options','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_save('skin-layout_option')" >
						</div>
					</form>
				</div>
			</div>
				...
				<div id="subscriber-provider-option" class="tab-pane fade in ">
					<form action="post" id="weblizar_rcsm_subscriber_provider_option">
						...
						<div class="form_deactivate-option <?php if($wl_rcsm_options['confirm_email_subscribe'] == 'off') echo "active"; ?>" id="deactivated_confirm_email_subscribe">
							<div class="col-md-12 form-group">
								<ul class="instruction_points">
									<li><?php _e('If Email Subscription is Enable: You have two options "Wp Mail" and "SMTP Mail" to mail the subscribers and confirm its subscription through email.', 'RCSM_TEXT_DOMAIN');?></li>
						...
						<div class="form_select-option <?php if($wl_rcsm_options['confirm_email_subscribe'] == 'on') echo "active"; ?>" id="confirm_email_subscribe">
							<div class="col-md-12 form-group">
								...
								<div class="col-md-6">
									...
									<select name="subscribe_select" id="subscribe_select" class="form-control">
										...
										<option value="smtp_mail" <?php echo selected($subscribe_select, 'smtp_mail' ); ?>><?php _e('SMTP Mail','RCSM_TEXT_DOMAIN');?></option>
									</select>
								</div>
							</div>
							...
							<div class="col-md-12 form-group subscribe-option <?php if ($subscribe_select=='smtp_mail') echo "active";?>" id="smtp_mail">
								<div class="col-md-12">
									<div class="col-md-6">
										<label><?php _e('SMTP Host ','RCSM_TEXT_DOMAIN');?></label>
										<label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="<?php _e(" Add SMTP Host Name Here. For Example - Gmail SMTP host name smtp.gmail.com. Yahoo SMTP host name smtp.mail.yahoo.com.","RCSM_TEXT_DOMAIN");?>"><i class="fa fa-info-circle tt-icon"></i></a></label>
										<input type="text" class="form-control" name="smtp_host_address" id="smtp_host_address" value="<?php echo $wl_rcsm_options['smtp_host_address']; ?>" />
									</div>
								</div>
								<div class="col-md-12">
									<div class="col-md-6">
										<label><?php _e('SMTP Port','RCSM_TEXT_DOMAIN');?></label>
										<label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="<?php _e("Add SMTP Port Number Here. For Example - Gmail SMTP Port is 465 or 587. For Example - Yahoo SMTP Port is 465 or 587.","RCSM_TEXT_DOMAIN");?>"><i class="fa fa-info-circle tt-icon"></i></a></label>
										<input type="text" class="form-control" name="smtp_port" id="smtp_port" value="<?php echo $wl_rcsm_options['smtp_port']; ?>" />
									</div>
								</div>
								<div class="col-md-12">
									<div class="col-md-6">
										<label><?php _e('Set The Encryption System To Use - SSL (Deprecated) or TLS','RCSM_TEXT_DOMAIN');?></label>
										<label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="<?php _e("Select and Set the encryption system to use - ssl (deprecated) or tls","RCSM_TEXT_DOMAIN");?>"><i class="fa fa-info-circle tt-icon"></i></a></label><br/>
										<?php $smtp_secure =$wl_rcsm_options['smtp_secure'];?>
										<select name="smtp_secure" id="smtp_secure" class="form-control">
											<option value="ssl" <?php echo selected($smtp_secure, 'ssl' ); ?>><?php _e('SSL','RCSM_TEXT_DOMAIN');?></option>
											<option value="tls" <?php echo selected($smtp_secure, 'tls' ); ?>><?php _e('TLS','RCSM_TEXT_DOMAIN');?></option>
										</select>
									</div>
								</div>
								<div class="col-md-12">
									<div class="col-md-6">
										<label><?php _e('SMTP Username ','RCSM_TEXT_DOMAIN');?></label>
										<label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="<?php _e("Add SMTP Username Here. For Gmail use your gmail email address like myname@gmail.com, use same as for Yahoo like myname@yahoo.com.","RCSM_TEXT_DOMAIN");?>"><i class="fa fa-info-circle tt-icon"></i></a></label>
										<input type="text" class="form-control" name="smtp_username" id="smtp_username" value="<?php echo $wl_rcsm_options['smtp_username']; ?>" />
									</div>
								</div>
								<div class="col-md-12">
									<div class="col-md-6">
										<label><?php _e('SMTP Password','RCSM_TEXT_DOMAIN');?></label>
										<label><a href="javascript:void(0)" data-toggle="tooltip" data-placement="right" title="<?php _e("Add SMTP Password Here. For Gmail use your gmail's email account password, use same as for yahoo email account password.","RCSM_TEXT_DOMAIN");?>"><i class="fa fa-info-circle tt-icon"></i></a></label>
										<input type="password" class="form-control" name="smtp_password" id="smtp_password" value="<?php echo $wl_rcsm_options['smtp_password']; ?>" />
									</div>
								</div>													
								<div class="col-md-12">
									<div class="col-md-6"></br>
									<label><?php _e('You can find all other SMTP Server configuration settings <a href="http://www.geeksquad.co.uk/articles/email-server-settings-setup-guide" target="_new">HERE</a>','RCSM_TEXT_DOMAIN');?></label>
									</div>
								</div>
							</div>
						</div>
	...
	<div class="tab-pane col-md-12" id="get_pro">
		<div class="col-md-12 option">
			<h1><?php _e('Upgrade To Pro & Get More','RCSM_TEXT_DOMAIN');?></h1>
			<div class="tab-content">
				<div id="get_pro-settings" class="tab-pane fade in active">	 <!-- Advance options General Setting -->
					<div class="col-md-12 form-group cs-back">
						<?php _e('<ul class="cs-desc"><li>Multiple Responsive Templates</li>
  <li>Coming Soon Mode</li>
  <li>Under Construction Mode</li>
  <li>Under Maintenance Mode</li>
  <li>503 Service Unavailable Mode</li>
  <li>Redirect Mode </li>
  <li>Live Preview</li>
  ...
  <li>SEO Friendly Coming Soon &amp; Landing Page Templates</li>
  <li>Google Analytic Tracking</li>
  <li>Advanced Access Control Via User Role / Username / IP</li>
  <li>Drag &amp; Drop Layout Template Layout Customization</li>
  <li>Multi Site Support </li>
  <li>Multilingual Translate Plugin In Any Language</li>
  <li>Unlimited Social Media Profile Links</li>
  <li>Custom HTML Editor Design Your Own Template</li>
  <li>500+ Google Fonts Family </li>
  <li>Unlimited Color Scheme</li>
  <li>Download * Filter Subscriber List</li>
  ...
  <li>Social Profile Section</li>
  <li>Banding &amp; Copyright Section</li>
  <li>Complete Plugin Documentation</li>
  <li>Priority Support To Paid Customers</li>
  </ul>
	<div class="row ms-links">
		<div class="col-md-4 col-sm-4 ms-btn">
			<h3>Try Live Demo</h3>
			<a class="btn link" target="_new" href="http://demo.weblizar.com/coming-soon-page-pro/" rel="nofollow">Click Here</a>
		</div>
		<div class="col-md-4 col-sm-4 ms-btn">
			<h3>Try Before Buy Using Admin Demo</h3>
			<a class="btn link" target="_new" href="http://demo.weblizar.com/coming-soon-page-pro-admin-demo/" rel="nofollow">Click Here</a>
			<p><strong>Username:</strong> userdemo</p><p><strong>Password:</strong> userdemo</p>
		</div>
		<div class="col-md-4 col-sm-4 ms-btn">
			<h3>Update To Pro</h3>
