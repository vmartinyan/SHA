...
function weblizar_rcsm_default_settings() {
	...
	$wl_rcsm_options=array(
		...
		'smtp_user_name' =>$LoggedInUsername1,
		'smtp_user_email_id' =>$LoggedInUserEmail1,
...
//Skin Layout Settings
function rcsm_skin_layout_setting() {
	$wl_rcsm_options = get_option('weblizar_rcsm_options');
...
function rcsm_subscriber_provider_setting() {
	...
	$wl_rcsm_options['smtp_user_name']=$LoggedInUsername1;		
	$wl_rcsm_options['smtp_user_email_id']= $LoggedInUserEmail1;
	$wl_rcsm_options['smtp_host_address'] ='smtp.gmail.com';
	$wl_rcsm_options['smtp_secure'] ='ssl';
	$wl_rcsm_options['smtp_port'] ='465';
	$wl_rcsm_options['smtp_username'] = '';
	$wl_rcsm_options['smtp_password'] ='';		
