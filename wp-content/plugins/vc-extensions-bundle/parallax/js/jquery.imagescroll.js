    ...
    ImageScroll = function (imageHolder, options) {
        return {
            init: function () {
                ...
                this.link = this.$imageHolder.data('link');
                this.target = this.$imageHolder.data('target');
                this.ticking = false;
                ...
                if (this.settings.touch === true) {
                    this.$scrollingElement.addClass('cq-parallaxmobileimage').css({maxWidth: '100%'}).prependTo(this.$imageHolder);
                    if(this.link!=""){
                        this.$scrollingElement.data('link', this.link);
                        this.$scrollingElement.data('target', this.target);
                        this.$scrollingElement.on('click', function(event) {
                    ...
                    if(this.link!=""){
                        this.$scrollerHolder.data('link', this.link).css('cursor', 'pointer');
                        this.$scrollerHolder.data('target', this.target);
                    }
            ...
            _adjustImgHolderHeights: function () {
                ...
                var _containerwidth = this.settings.container.width();
