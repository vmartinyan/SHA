...
if (!class_exists('VC_Extensions_CQThumbnailCaption')) {
    ...
    class VC_Extensions_CQThumbnailCaption {
        function VC_Extensions_CQThumbnailCaption() {
          wpb_map(array(
        ...
        function cq_vc_thumbnailcaption_func($atts, $content=null) {
          ...
          $image_content .= '<div class="card-image">';
            foreach ($imagesarr as $key => $image) {
                ...
                if($onclick=="lightbox"){
                  ...
                  $image_content .= '<img src="'.$return_img_arr[0].'" />';
                  $image_content .= '</a>';
        ...
        add_shortcode('cq_vc_thumbnailcaption', 'cq_vc_thumbnailcaption_func');
