...
if (!class_exists('VC_Extensions_AppMockup')) {
    ...
    class VC_Extensions_AppMockup {
        function VC_Extensions_AppMockup() {
          wpb_map( array(
            ...
            "params" => array(
              ...
              array(
                "type" => "textfield",
                "heading" => __("Extra class name for the icon", "vc_appmockup_cq"),
                "param_name" => "icon_class",
                "description" => __("You can append extra class to the font awesome icon, for example, fa-spin will make the icon spin.", "vc_appmockup_cq")
              ),
              array(
                "type" => "textfield",
                "heading" => __("Extra class name for the thumbnail", "vc_appmockup_cq"),
                "param_name" => "thumb_class",
                "description" => __("You can append extra class to the thumbnail (li tag here).", "vc_appmockup_cq")
              )
            )
        ...
        function cq_vc_appmockup_func($atts, $content=null) {
          ...
          foreach ($imagesarr as $key => $image_url) {
              ...
              $output .= $link_start;
              $output .= '<li class="'.$imagedirection.'" data-image="'.$resized_img[0].'" data-title="'.$tooltip.'">';
        ...
        add_shortcode('cq_vc_appmockup', 'cq_vc_appmockup_func');
