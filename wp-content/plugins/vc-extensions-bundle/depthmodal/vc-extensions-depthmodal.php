...
if (!class_exists( 'VC_Extensions_DepthModal' ) ) {
    ...
    class VC_Extensions_DepthModal {
        function VC_Extensions_DepthModal() {
            ...
            wpb_map( array(
              ...
              "params" => array(
                ...
                "holder" => "",
                "class" => "vc_modal_cq",
                "heading" => __("Display the Popup in:", "vc_modal_cq"),
                "param_name" => "popupposition",
                "value" => array("fixed" => "fixed", "absolute (work better for long contnet)" => "absolute"),
                "description" => __("CSS position value for the Popup.", "vc_modal_cq")
              ),
                array(
                  "type" => "checkbox",
                  "holder" => "",
        ...
        function cq_vc_modal_func( $atts, $content=null) {
          ...
          return "<div class='avgrund-container' data-width='${width}' data-textcolor='${textcolor}' data-background='${background}' data-loadedvisible='${loadedvisible}' data-padding='${padding}' data-margintop='${margintop}' data-popupposition='${popupposition}'><div class='avgrund-popup'>
