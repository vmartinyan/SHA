...
if (!class_exists('VC_Extensions_Accordion')) {
    ...
    class VC_Extensions_Accordion {
            ...
            "params" => array(
              array(
                ...
                "value" => __("[accordionitem]
                  ...
                  [/accordionitem]", "vc_accordion_cq"), "description" => __("Enter content for each block here. Divide each with paragraph (Enter).", "vc_accordion_cq") ),
              array(
                "type" => "dropdown",
                "holder" => "",
        ...
        function cq_vc_accordion_func($atts, $content=null) {
