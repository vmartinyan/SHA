    ...
    class VC_Extensions_SideBySide{
        ...
        function cq_vc_sidebyside_func($atts, $content=null) {
          ...
          extract(shortcode_atts(array(
            ...
            'divider_icon_openiconic' => '',
            'divider_icon_typicons' => '',
            'divider_icon_entypoicons' => '',
            'divider_icon_linecons' => '',
            'divider_icon_entypo' => '',
            'card2_icon_fontawesome' => '',
            'card2_icon_openiconic' => '',
            'card2_icon_typicons' => '',
            'card2_icon_entypoicons' => '',
            'card2_icon_linecons' => '',
            'card2_icon_entypo' => '',
            "divider" => '',
            "dividericon" => '',
