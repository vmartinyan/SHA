...
if (!class_exists('VC_Extensions_FullscreenIntro')) {
    class VC_Extensions_FullscreenIntro{
        function VC_Extensions_FullscreenIntro() {
          wpb_map(array(
        ...
        function cq_vc_fullscreenintro_func($atts, $content=null) {
        ...
        add_shortcode('cq_vc_fullscreenintro', 'cq_vc_fullscreenintro_func');
