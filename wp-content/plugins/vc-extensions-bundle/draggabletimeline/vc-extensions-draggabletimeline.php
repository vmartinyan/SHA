...
if (!class_exists('VC_Extensions_DraggableTimeline')) {
    ...
    class VC_Extensions_Draggabletimeline {
        function VC_Extensions_DraggableTimeline() {
          wpb_map(array(
        ...
        function cq_vc_draggabletimeline_func($atts, $content=null) {
          ...
          wp_register_style('perfect-scrollbar', plugins_url('css/perfect-scrollbar.css', __FILE__));
          wp_enqueue_style('perfect-scrollbar');

          wp_register_script('slick', plugins_url('../testimonialcarousel/slick/slick.min.js', __FILE__), array("jquery"));
          wp_enqueue_script('slick');
          wp_register_script('perfect-scrollbar', plugins_url('js/perfect-scrollbar.min.js', __FILE__), array("jquery"));
            ...
            foreach ($imagesarr as $key => $image) {
                ...
                if($return_img_arr[0]){
                    $output .= '<div class="cq-highlight '.$avatarshape.'">';
                      $output .= '<img src="'.aq_resize($return_img_arr[0], $retina=="on"?$imagewidth*2:$imagewidth, $retina=="on"?$imagewidth*2:$imagewidth, true, true, true).'" width="'.$imagewidth.'" />';
                    $output .= '</div>';
        ...
        add_shortcode('cq_vc_draggabletimeline', 'cq_vc_draggabletimeline_func');
