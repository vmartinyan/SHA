...
if (!class_exists('VC_Extensions_TestimonialCarousel')) {
    ...
    class VC_Extensions_TestimonialCarousel {
        function VC_Extensions_TestimonialCarousel() {
          wpb_map( array(
...
dHRwOi8vY29kZWNhbnlvbi5uZXQvdXNlci9zaWtlIj5MaW5rPC9hPg0KUHJvZHVjdCBNYW5hZ2Vy", 'vc_testimonialcarousel_cq'),
        ...
        function cq_vc_testimonialcarousel_func($atts, $content=null) {
          ...
          // wp_register_style( 'slick', plugins_url('slick/style.css', __FILE__) );
          ...
          foreach ($testimonialcontentarr as $key => $value) {
              ...
              // if(wp_get_attachment_image_src(trim($value), 'full')){
                  ...
                  if($return_img_arr[0]!=""){
                    ...
                    $output .= '<img src="'.aq_resize($return_img_arr[0], $retina=="on"?$avatarwidth*2:$avatarwidth, $retina=="on"?$avatarheight*2:$avatarheight, true, true, true).'" width="'.$avatarwidth.'" />';
                    if($avatarlinkarr[$i]!=""){
                      $output .= '</a>';
                    }
                    $output .= '</div>';
        ...
        add_shortcode('cq_vc_testimonialcarousel', 'cq_vc_testimonialcarousel_func');
